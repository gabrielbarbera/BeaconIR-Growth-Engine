...
import { mockCompany, mockKPIs, mockMarketData, mockFilings, mockPressReleases, mockMilestones } from "@/lib/mock-data";
...
export default function DemoPage() {
  ...
  // Growth Engine component structure
        ...
        <div className="container mx-auto px-4">
          <div className="text-center">
            ...
            <p className="text-xs text-gray-500 mt-2">
              This is a demo of the Growth Engine template. Template provided by Beacon IR.
            </p>
          </div>
        </div>
      </footer>
